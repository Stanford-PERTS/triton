...
describe('LoginForm validate', () => {
  it('should not flag PERTS email and password', () => {
    const values = { email: 'viper@perts.net', password: 'passwordEntered' };
  ...
  it('should flag missing password', () => {
    const values = { email: 'viper@perts.net', password: null };
